  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {[
          {name: 'Core CRM', icon: <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path>},
          {name: 'Core ERP', icon: <rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect>},
          {name: 'Panels', icon: <rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect>},
          {name: 'Mobile App', icon: <rect x="5" y="2" width="14" height="20" rx="2" ry="2"></rect>},
          {name: 'Integrations & API', icon: <path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"></path>},
          {name: 'Customize your menu', icon: <circle cx="12" cy="12" r="3"></circle>}
        ].map((item, idx) => (
          <div key={idx} style={{
            padding: '0.6rem 1.2rem', color: '#475569', fontSize: '0.8rem', fontWeight: '600', 
            ...
            {idx < 3 && <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg>}
          </div>
        ))}
      </div>
...
fs.writeFileSync('d:/demo/client/src/components/LiveDashboardPreview.jsx', jsxContent);
console.log('LiveDashboardPreview.jsx created.');
